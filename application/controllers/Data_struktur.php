...
class Data_struktur extends CI_Controller
{
	...
	{
		parent::__construct();
		$this->load->model('model_data_struktur');
		$this->load->model('model_user');
	}

	function index()
	{
		$data['title'] = "Manajemen Data Struktur";
		$data['record'] = $this->model_data_struktur->tampilkan_data();
		$this->template->load('template_backend','backend/data_struktur/lihat_data',$data);
	}
