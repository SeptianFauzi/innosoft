<div class="box box-info">
	<div class="box-header with-border">
		<h3 class="box-title">Lihat Artikel Kontak</h3>
	</div>
	<div class="box-body">
		<?php
		echo form_open_multipart('kontak/lihat_data_detil','class="form-horizontal"');
		?>
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<img src="<?php echo base_url(); ?>foto_user/<?php echo $record['artikel_gambar']; ?>" width="50%">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<label class="form-control" ><?php echo $record['profil_user_nama']; ?></label>
				</div>
			</div>
		...
		<div class="box-footer">
			...
			echo "
			".anchor('kontak/edit/'.$ids,'<i class="fa fa-pencil"></i>', array('title' => 'Edit','class' => 'btn bg-aqua pull-right'))."
			".anchor('kontak/'.$ids,'<i> </i>', array('title' => 'Edit','class' => 'btn bg-white pull-right'))."
			".anchor('kontak/','<i>Kembali</i>', array('title' => 'Edit','class' => 'btn bg-aqua pull-right'))."
			"
			?>
		</div>
	</form>
