<div class="box box-info">
	<div class="box-header with-border">
		<h3 class="box-title">Lihat Artikel Event</h3>
	</div>
	<div class="box-body">
		<?php
		echo form_open_multipart('artikel_event/lihat_data_detil','class="form-horizontal"');
		?>
		...
		<div class="box-footer">
			...
			echo "
			".anchor('artikel_event/edit/'.$ids,'<i class="fa fa-pencil"></i>', array('title' => 'Edit','class' => 'btn bg-aqua pull-right'))."
			".anchor('artikel_event/lihat_data_detil/'.$ids,'<i> </i>', array('title' => 'Edit','class' => 'btn bg-white pull-right'))."
			".anchor('artikel_event/','<i>Kembali</i>', array('title' => 'Edit','class' => 'btn bg-aqua pull-right'))."
			"
			?>
		</div>
	</form>
