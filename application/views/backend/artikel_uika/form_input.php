<div class="box box-info">
	<div class="box-header with-border">
		<h3 class="box-title">Tambah Artikel UIKA</h3>
	</div>
	<div class="box-body">
		<?php
		echo form_open_multipart('artikel_uika/post','class="form-horizontal"');
		?>
		<div class="box-body">
			...
			<input type="hidden" name="artikel_katagori" class="form-control" value="berita_uika">
