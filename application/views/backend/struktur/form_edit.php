<div class="box box-info">
	<div class="box-header with-border">
		<h3 class="box-title">Edit Artikel Struktur</h3>
	</div>
	<div class="box-body">
		<?php
		echo form_open_multipart('struktur/edit','class="form-horizontal"');
		?>
		<div class="box-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<select class="form-control" name="user_id">
						<option value="<?php echo $record['user_id']; ?>"><?php echo $record['user_id']; ?></option>
						<?php
