<div class="box box-info">
	<div class="box-header with-border">
		<h3 class="box-title">Lihat Artikel Struktur</h3>
	</div>
	<div class="box-body">
		<?php
		echo form_open_multipart('struktur/lihat_data_detil','class="form-horizontal"');
		?>
		...
		<div class="box-footer">
			...
			echo "
			".anchor('struktur/edit/'.$ids,'<i class="fa fa-pencil"></i>', array('title' => 'Edit','class' => 'btn bg-aqua pull-right'))."
			".anchor('struktur/'.$ids,'<i> </i>', array('title' => 'Edit','class' => 'btn bg-white pull-right'))."
			".anchor('struktur/','<i>Kembali</i>', array('title' => 'Edit','class' => 'btn bg-aqua pull-right'))."
			"
			?>
		</div>
	</form>
