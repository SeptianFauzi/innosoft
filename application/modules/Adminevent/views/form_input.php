...
<form  enctype="multipart/form-data" id="formevent" class="form-horizontal" method="post"> 	<!-- Form Input -->
		<div class="box-body">

			<div class="form-group">
				<label for="judul_events" class="col-sm-2 control-label">Judul</label>
				<div class="col-sm-6">
					<input type='text' data-validetta="required" data-vd-message-required="wajib di isi" class="form-control" name="judul_events" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
						<input type="text" data-validetta="required" data-vd-message-required="wajib di isi" id="datetimepicker" class="form-control" name="waktu_events"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-1">
					<div class="input-group">
						<input type="text" data-validetta="required,maxLength[4],number" data-vd-message-number="Wajib Di Isi Angka" data-vd-message-maxLength="Maksimum 4 Digit Angka" data-vd-message-required="wajib di isi" class="form-control" name="kuota_events">
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-1">
					<input type="text" data-validetta="required,maxLength[4],number" data-vd-message-number="Wajib Di Isi Angka" data-vd-message-maxLength="Maksimum 4 Digit Angka" data-vd-message-required="wajib di isi" class="form-control" name="kuota_max_events">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<textarea type="text" data-validetta="required" data-vd-message-required="wajib di isi" name="lokasi_events" class="form-control"></textarea>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<textarea data-validetta="required" data-vd-message-required="wajib di isi" type="text" class="form-control" name="software_events"></textarea>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<textarea data-validetta="required" data-vd-message-required="wajib di isi" type="text" class="form-control" cols="80" rows="6" name="desc_events"></textarea>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input  type="file"  name="img_poster_events" id="poster" data-validetta="required" data-vd-message-required="Wajib di isi" class="form-control">
				</div>
			</div>
<small class="form-text text-muted">Maksimum Ukuran Gambar 3 MB</small>
		</div>
		<div class="box-footer">
			<button type="submit" class="btn btn-green pull-right" name="submit">Tambah <i class="fa fa-send"></i> </button>
		</div>
	</form> <!--  End Form Input -->
</div>
</div>
	...
	$('#formevent').validetta({
	  ...
	  onValid : function(event){
	    ...
	    if(x > 3)
	    {
	      ...
	      $.ajax({
	        url: "<?php echo base_url();?>Adminevent/post",
	        type: "POST",
