	...
	<div class="box-body">
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input data-validetta="required" data-vd-message-required="Tidak ada file" type="file" id="foto" name="user_profil_foto" class="form-control"  >
				</div>
...
$('#formtambah').validetta({
  ...
  onValid : function(event){
    ...
    if(x > 3)
    {
      ...
      $.ajax({
        url: "<?php echo base_url();?>admin/post",
        type: "POST",
